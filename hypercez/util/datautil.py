...
from gymnasium_robotics.utils.rotations import quat_mul, quat_conjugate
...
class DataCollector:
    ...
    def add(self, x_t, u, r, x_tt, task_id):
        # Convert Format
        ...
        if task_id in self.states:
            ...
            if self.normalize_xu:
                ...
                self.rewards_aggregate[task_id] = self.update(self.rewards_aggregate[task_id], r)
        else:
            ...
            if self.normalize_xu:
                ...
                self.rewards_aggregate[task_id] = self.update((0, 0, 0), r)
        # Train or val
