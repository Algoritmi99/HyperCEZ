...
class PusherFullRange(PusherEnv, utils.EzPickle):
    ...
    """
    def __init__(self, model_path=os.path.dirname(gymnasium.envs.mujoco.__file__) + "/assets/pusher.xml", **kwargs):
...
#     Simply allows changing of XML file, probably not necessary if we pull request the xml name as a kwarg in openai gym
#     """
#     def __init__(self, model_path=os.path.dirname(gymnasium.envs.mujoco.__file__) + "/assets/striker.xml", **kwargs):
#         self._striked = False
