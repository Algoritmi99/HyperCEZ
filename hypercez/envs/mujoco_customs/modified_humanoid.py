...
HumanoidWallEnv = lambda *args, **kwargs : WallEnvFactory(ModifiedHumanoidEnv)(
    model_path=os.path.dirname(gymnasium.envs.mujoco.__file__) + "/assets/humanoid.xml", ori_ind=-1, *args, **kwargs
)

HumanoidStandupAndRunWallEnv = lambda *args, **kwargs : WallEnvFactory(HumanoidStandupAndRunEnv)(
    model_path=os.path.dirname(gymnasium.envs.mujoco.__file__) + "/assets/humanoidstandup.xml"
    , ori_ind=-1,
    *args,
    **kwargs
)

HumanoidGravityEnv = lambda *args, **kwargs : GravityEnvFactory(ModifiedHumanoidEnv)(
    model_path=os.path.dirname(gymnasium.envs.mujoco.__file__) + "/assets/humanoid.xml", *args, **kwargs
)

HumanoidModifiedBodyPartSizeEnv = lambda *args, **kwargs : ModifiedSizeEnvFactory(ModifiedHumanoidEnv)(
    model_path=os.path.dirname(gymnasium.envs.mujoco.__file__) + "/assets/humanoid.xml", *args, **kwargs
)
...
class HumanoidStandupAndRunEnv(HumanoidEnv, utils.EzPickle):
    ...
    """
    def __init__(self, model_path=os.path.dirname(gymnasium.envs.mujoco.__file__) + "/assets/humanoidstandup.xml", **kwargs):
        mujoco_env.MujocoEnv.__init__(self, model_path, 5, None)
        utils.EzPickle.__init__(self)
...
class HumanoidStandupAndRunEnvWithSensor(HumanoidStandupAndRunEnv, utils.EzPickle):
    ...
    """
    def __init__(self, model_path=os.path.dirname(gymnasium.envs.mujoco.__file__) + "/assets/humanoidstandup.xml", n_bins=10, **kwargs):
        self.n_bins = n_bins
        mujoco_env.MujocoEnv.__init__(self, model_path, 5, None)
        utils.EzPickle.__init__(self)
