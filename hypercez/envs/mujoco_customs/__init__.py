...
custom_envs = {
    ...
    "PusherMovingGoal-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_arm:PusherMovingGoalEnv',
             max_episode_steps=100,
             reward_threshold=0.0,
             kwargs=dict()),
    # Pusher modifications
    "PusherLeftSide-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_arm:PusherLeftSide',
             max_episode_steps=100,
             reward_threshold=0.0,
             kwargs=dict()),
    "PusherFullRange-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_arm:PusherFullRange',
             max_episode_steps=100,
             reward_threshold=0.0,
             kwargs=dict()),
    # Striker
    # "StrikerMovingStart-v0":
    #     dict(path='hypercez.envs.mujoco_customs.modified_arm:StrikerMovingStartStateEnv',
    #          max_episode_steps=100,
    #          reward_threshold=0.0,
    #          kwargs=dict()),
    ...
    "AntGravityMars-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_ant:AntGravityEnv',
    ...
    "HopperGravityHalf-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_hopper:HopperGravityEnv',
             max_episode_steps=1000,
             reward_threshold=3800.0,
             kwargs=dict(gravity=-4.905)),
    ...
    "Walker2dGravityHalf-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_walker2d:Walker2dGravityEnv',
             max_episode_steps=1000,
             kwargs=dict(gravity=-4.905)),
    ...
    "HalfCheetahGravityHalf-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_half_cheetah:HalfCheetahGravityEnv',
             max_episode_steps=1000,
    ...
    "HumanoidGravityHalf-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_humanoid:HumanoidGravityEnv',
             max_episode_steps=1000,
             kwargs=dict(gravity=-4.905)),
    ...
    "AntMaze-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_ant:AntMaze',
             max_episode_steps=1000,
             reward_threshold=3800.0,
             kwargs=dict()),
    "HopperStairs-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_hopper:HopperStairs',
             max_episode_steps=1000,
             reward_threshold=3800.0,
             kwargs=dict()),
    "HopperSimpleWall-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_hopper:HopperSimpleWallEnv',
             max_episode_steps=1000,
             reward_threshold=3800.0,
             kwargs=dict()),
    ...
    "HopperBigTorso-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_hopper:HopperModifiedBodyPartSizeEnv',
             max_episode_steps=1000,
             reward_threshold=3800.0,
    ...
    "Walker2dBigTorso-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_walker2d:Walker2dModifiedBodyPartSizeEnv',
             max_episode_steps=1000,
             kwargs=dict(body_parts=["torso_geom"], size_scale=1.25)),
    "Walker2dBigThigh-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_walker2d:Walker2dModifiedBodyPartSizeEnv',
    ...
    "HalfCheetahBigTorso-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_half_cheetah:HalfCheetahModifiedBodyPartSizeEnv',
             max_episode_steps=1000,
             reward_threshold=4800.0,
    ...
    "HumanoidBigTorso-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_humanoid:HumanoidModifiedBodyPartSizeEnv',
             max_episode_steps=1000,
    ...
    # Modified pole size - InvertedPendulum
    "InvertedPendulumSmallPole-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_invertedpendulum:InvertedPendulumModifiedLengthEnv',
             max_episode_steps=1000,
             kwargs=dict(body_parts=["cpole"], size_scale=.75)),
    "InvertedPendulumBigPole-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_invertedpendulum:InvertedPendulumModifiedLengthEnv',
             max_episode_steps=1000,
             kwargs=dict(body_parts=["cpole"], size_scale=1.25)),

    # Modified 
    "ReacherLong1-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_reacher:ReacherLengthEnv',
             max_episode_steps=50,
             kwargs=dict(length=[0.11, 0.11])),
    "ReacherLong2-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_reacher:ReacherLengthEnv',
             max_episode_steps=50,
             kwargs=dict(length=[0.12, 0.12])),
    "ReacherLong3-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_reacher:ReacherLengthEnv',
             max_episode_steps=50,
             kwargs=dict(length=[0.13, 0.13])),
    "ReacherLong4-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_reacher:ReacherLengthEnv',
             max_episode_steps=50,
             kwargs=dict(length=[0.12, 0.10])),
    "ReacherShort1-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_reacher:ReacherLengthEnv',
             max_episode_steps=50,
             kwargs=dict(length=[0.09, 0.09])),
    "ReacherShort2-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_reacher:ReacherLengthEnv',
             max_episode_steps=50,
             kwargs=dict(length=[0.08, 0.08])),
    "ReacherShort3-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_reacher:ReacherLengthEnv',
             max_episode_steps=50,
             kwargs=dict(length=[0.07, 0.09])),
    "ReacherShort4-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_reacher:ReacherLengthEnv',
             max_episode_steps=50,
             kwargs=dict(length=[0.09, 0.07])),
    "ReacherShort5-v0":
        dict(path='hypercez.envs.mujoco_customs.modified_reacher:ReacherLengthEnv',
             max_episode_steps=50,
             kwargs=dict(length=[0.08, 0.10])),
}
